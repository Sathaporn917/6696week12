...
<form action="edit_1.php" method="POST">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-2">
            ...
            <div class="row mb-3">
        <label class="col-sm-1 col-form-label"> เเผนก </label>
        <div class="col-sm-2">
        <select name="department"="form-select" aria-label="Default select example">
  <option selected>กรุณาระบุเเผนก</option>
  ...
  <option value="ฝ่ายผลิต"<?php if ($row['department']=='ฝ่ายผลิต'){ echo "selected";} ?>>ฝ่ายผลิต</option>
        ...
        <div class="col-sm-2">
        <select name="gender"="form-select" aria-label="Default select example">
